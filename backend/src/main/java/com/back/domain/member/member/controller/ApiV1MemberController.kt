...
open class ApiV1MemberController(
    ...
    open fun join(@Valid @RequestBody reqBody: MemberJoinReqBody): RsData<MemberDto> {
    ...
    open fun login(@Valid @RequestBody reqBody: MemberLoginReqBody): RsData<MemberLoginResBody> {
    ...
    open fun me(): MemberWithUsernameDto {

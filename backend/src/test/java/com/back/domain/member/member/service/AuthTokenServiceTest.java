...
public class AuthTokenServiceTest {
    ...
    void t3() {
        ...
        assertThat(Ut.jwt.INSTANCE.isValid(jwtSecretKey, jwt))
                .isTrue();

        Map<String, Object> parsedPayload = Ut.jwt.INSTANCE.payload(jwtSecretKey, jwt);
